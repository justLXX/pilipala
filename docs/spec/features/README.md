...
|------|----------|----------|------|----------|--------|
| 首页推荐 | `features/home/` | `lib/features/home/` | HomePage, RcmdPage | ✅ 已迁移 (~85%) | P0 |
| 热门排行 | `features/hot/` | `lib/features/home/` | HotPage | ✅ 部分迁移（热门已在 home，排行榜待迁） | P0 |
| 视频详情 | `features/video/` | `lib/features/video/` | VideoDetailPage | ✅ 已迁移 (~65%) | P0 |
| 搜索 | `features/search/` | `lib/features/search/` | SearchPage | ✅ 已迁移 (~55%) | P0 |
| 动态 | `features/dynamics/` | `lib/pages/dynamics/` | DynamicsPage | ❌ 未迁移（有 spec） | P1 |
| 用户中心 | `features/user/` | `lib/features/user/` | MemberPage | ✅ 已迁移 (~60%) | P1 |

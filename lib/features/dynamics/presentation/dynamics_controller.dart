...
class DynamicsController extends GetxController {
  final GetFollowDynamicsUseCase _getFollowDynamics;
  final GetFollowUpUseCase _getFollowUp;

  DynamicsController({
    GetFollowDynamicsUseCase? getFollowDynamics,
    GetFollowUpUseCase? getFollowUp,
  })  : _getFollowDynamics = getFollowDynamics ?? GetFollowDynamicsUseCase(),
        _getFollowUp = getFollowUp ?? GetFollowUpUseCase();
  ...
  Future queryFollowDynamic({type = 'init'}) async {
    ...
    var res = await _getFollowDynamics.execute(
  ...
  Future queryFollowUp({type = 'init'}) async {
    ...
    var res = await _getFollowUp.execute();
    if (res['status']) {

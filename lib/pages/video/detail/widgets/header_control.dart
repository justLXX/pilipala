                ...
                child: ListView(
                  children: [
                    ...
                    if (widget.videoDetailCtr!.currentDecodeFormats != null)
                      ListTile(
                        onTap: () => {safeBack(), showSetDecodeFormats()},
                        dense: true,
